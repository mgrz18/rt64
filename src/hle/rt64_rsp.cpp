...
#       endif
        ...
        // 2026-05-04: GE_FORCE_SHADE=1 forces G_SHADE bit so vertex colors
        // propagate. Required for visible scene rendering in GE.
        ...
        for (uint32_t i = dstIndex; i < dstMax; i++) {
            ...
            // 2026-05-04: GE_RAW_VTX_COLOR=1 forces compute shader to use
            // raw vertex rgba (no lighting), bypassing GE's lights producing
            // zero colors.
